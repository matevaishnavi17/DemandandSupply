...
namespace FileuploadApi.Controllers{
    ...
    public FileUploadController(DemandAndSupply_Db1Context dbContext)
    {
...
<<<<<<< HEAD:DemandAndSupply_FileUpload/Controllers/UploadFileController.cs

         // Validate file size
=======
        // Validate file size
>>>>>>> dec20f2948a23f207f9283869bfbd944bf7a54e4:Deamnd&Supply_FileUpload/FileuploadApi/Controllers/FileUploadController.cs
...
>>>>>>> dec20f2948a23f207f9283869bfbd944bf7a54e4:Deamnd&Supply_FileUpload/FileuploadApi/Controllers/FileUploadController.cs
        using (var package = new ExcelPackage(file.OpenReadStream()))
        {
            ...
            List<DemandSupplyTbl2> demandData = new List<DemandSupplyTbl2>();
            for (int row = 2; row <= rowCount; row++) // Assuming the first row contains headers
            {
                demandData.Add(new DemandSupplyTbl2
                {
...
=======
                    //RoleStartDate = DateTime.Parse((string)worksheet.Cells[row, 21].Value),
                    //RoleEndDate = DateTime.Parse((string)worksheet.Cells[row, 22].Value),
>>>>>>> dec20f2948a23f207f9283869bfbd944bf7a54e4:Deamnd&Supply_FileUpload/FileuploadApi/Controllers/FileUploadController.cs
                    ...
                    //CreationDate = DateTime.Parse((string)worksheet.Cells[row, 31].Value),
                    CreationDate = worksheet.Cells[row, 31].Value?.ToString(),
                    //UpdatedOn = DateTime.Parse((string)worksheet.Cells[row, 32].Value),
                    ...
                    //ThorCloseDate = DateTime.Parse((string)worksheet.Cells[row, 80].Value?),
...
=======
                     //ThorCloseDate= DateTime.Parse((string)worksheet.Cells[row,80].Value),
                     //ThorStartDate = DateTime.Parse((string)worksheet.Cells[row, 81].Value),
>>>>>>> dec20f2948a23f207f9283869bfbd944bf7a54e4:Deamnd&Supply_FileUpload/FileuploadApi/Controllers/FileUploadController.cs
            ...
            // Store data into the database
                 await _dbContext.DemandSupplyTbl2s.AddRangeAsync(demandData);
