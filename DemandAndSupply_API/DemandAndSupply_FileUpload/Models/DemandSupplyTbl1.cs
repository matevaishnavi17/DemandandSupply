...
{
    public partial class DemandSupplyTbl1
    {
        ...
        public string Buskills { get; set; }
        ...
        public string TeamRequestComment { get; set; }
        ...
        public string ThorCloseDate { get; set; }
        public string ThorStartDate { get; set; }
        ...
        public string AgedPastDue { get; set; }
        ...
        public string SelfAppliedApplications { get; set; }
        public string Visible { get; set; }
        public string IsClientInterviewRequired { get; set; }
        public string ExcludeOffshore { get; set; }
        public string LeadMarketAndPractice { get; set; }
